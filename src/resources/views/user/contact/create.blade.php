    ...
    <div class="container-fluid px-0 main-content">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form id="contact_store" action="{{route('user.contact.store')}}" method="POST">
                    @csrf
                        ...
                        <div class="tab-pane fade show active" id="single-tab-pane" role="tabpanel">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-6">
                                            <div class="form-inner">
                                                ...
                                                <input type="number" id="whatsapp_contact" name="whatsapp_contact" class="form-control" placeholder="Enter whatsapp" aria-label="Enter whatsapp contact number" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-inner">
                                                ...
                                                <input type="number" 
                                                    ...
                                                    name="sms_contact" 
                                                    class="form-control" 
                                                    placeholder="{{translate('Enter SMS Contact Number')}}" 
                                                    aria-label="Enter sms contact number" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                            ...
                            @if(count($filtered_meta_data) != 0)
                                <div class="form-element">
                                    <div class="row gy-3">
                                        <div class="col-xxl-2 col-xl-3">
                                            <h5 class="form-element-title"> {{ translate("Custom Attribute")}} <a href="{{ route("user.contact.settings.index") }}" target="_blank"><i class="ri-external-link-line"></i></a></h5>
                                        </div>
                                        <div class="col-xxl-7 col-xl-9">
                                            <div class="row gy-4">
                                ...
                                @else
                                    <div class="form-item my-3">
                                        <a href="{{ route("user.contact.settings.index") }}" class="i-btn primary--btn btn--md">{{ translate('Add More Attributes')}}</a>
                                ...
                                <div class="row gy-3">
                                  ...
                                  <div class="col-xxl-7 col-xl-9">
                                    <div class="form-inner">
                                      ...
                                      <p class="form-element-note">{{ translate("Download a demo CSV file from this link: ") }}<a href="{{ route("user.contact.demo.file", "csv" ) }}">{{translate('demo csv')}}</a></p>
                                    </div>
                                  </div>
                                </div>
                            </div>
	...
	(function($){
        ...
        $(document).ready(function() {
            ...
            function deleteFile(fileName, csrfToken) {
                return $.ajax({
                    url: '{{ route("user.contact.delete.file") }}',
                    type: 'POST',
                    data: {
                        file_name: fileName,
                    },
            ...
            $("#file_upload").change(function () {
                ...
                $.ajax({
                    url: '{{ route("user.contact.upload.file") }}',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
                    ...
                    success: function (response) {
                        if (response.status) {
                            ...
                            reader.onload = function (e) {
                                ...
                                $.ajax({
                                    url: '{{ route("user.contact.parse.file") }}',
                                    type: 'POST',
                                    data: {
                                        fileType: fileType,
                                        filePath: filePath
