    ...
    <div class="container-fluid px-0 main-content">
      ...
      <div class="card">
        ...
        <div class="card-body pt-0">
          <form action="{{route('user.communication.store', ['type' => 'sms'])}}" method="POST" enctype="multipart/form-data" id="sms_send">
            @csrf
                  ...
                  <div class="form-element">
                      ...
                      <div class="col-xxl-7 col-lg-9">
                          <div class="form-inner">
                              ...
                              <input type="number" class="form-control" name="contacts" id="sms_contact" placeholder="{{ translate("Enter recipient contact number") }}" aria-label="sms_contact" autocomplete=""/>
                          </div>
                      </div>
                      </div>
                  </div>
                        ...
                        <div class="col-12">
                          <div class="form-inner">
                            ...
                            <select class="form-select select2-search" id="chooseMethod" data-placeholder="{{ translate("Choose a sending method") }}" aria-label="chooseMethod" name="method">
                              <option value=""></option>
                              @if(array_key_exists('is_allowed', $plan_access->android) && $plan_access->android['is_allowed'])
                                <option value="{{ \App\Enums\StatusEnum::FALSE->status() }}">{{ translate("Android Gateway") }}</option>
                              @endif
                              @if(array_key_exists('is_allowed', $plan_access->sms) && $plan_access->sms['is_allowed'])
