...
<main class="main-body">
    <div class="container-fluid px-0 main-content">
        ...
        <form action="{{route('user.communication.email.campaign.save', ['type' => 'email'])}}" class="step-content" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row gy-3">
                          ...
                          <div class="col-xxl-7 col-lg-9">
                            ...
                            <div class="form-inner mb-3">
                              ...
                              <input type="text" class="form-control" name="email_from_name" id="email_from_name" value="{{ $campaign->meta_data['message']['email_from_name'] }}" placeholder="{{ translate("Enter email from name") }}" aria-label="email_from_name" autocomplete=""/>
                            </div>
                            ...
                            <div class="form-inner mb-3">
                              ...
                              <input type="email" class="form-control" name="reply_to_address" id="reply_to_address" value="{{ $campaign->meta_data['message']['reply_to_address'] }}" placeholder="{{ translate("Enter reply to email address") }}" aria-label="reply_to_address" autocomplete=""/>
                            </div>
                          </div>
                        </div>
                    </div>
                    <div class="form-element">
                        <div class="row gy-3">
                            ...
                            <div class="form-inner mb-3">
                                ...
                                <input type="text" class="form-control" name="message[subject]" value="{{ $campaign->meta_data['message']['subject'] }}" id="email_contact" placeholder="{{ translate("Enter email subject") }}" aria-label="subject" autocomplete=""/>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (editors['#message']) {
            ...
            editors['#message'].setData(@json($campaign->meta_data['message']['message_body']));
        }
