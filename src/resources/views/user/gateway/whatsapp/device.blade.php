    ...
    <div class="card">
        ...
        @else
            <div class="card">
                ...
                <div class="card-body">
                    <h6 class="text--danger">{{ translate('Unable to connect to WhatsApp node server. Please contact admin.') }} <a href="{{route('user.support.ticket.create')}}">{{translate("Create Ticket")}}</a></h6>
                </div>
            </div>
        @endif
    </div>
...
<div class="modal fade" id="addWhatsappDevice" tabindex="-1" aria-labelledby="addWhatsappDevice" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered ">
        <div class="modal-content">
            <form action="{{route('user.gateway.whatsapp.device.save')}}" method="POST">
                @csrf
...
<div class="modal fade actionModal" id="deleteWhatsappDevice" tabindex="-1" aria-labelledby="deleteWhatsappDevice" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        ...
        <form action="{{route('user.gateway.whatsapp.device.delete')}}" method="POST">
            @csrf
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasQrCode" aria-labelledby="offcanvasQrCode" data-bs-backdrop="static">
    <div class="offcanvas-header justify-content-between bg-light">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Connect Whatsapp</h5>
        <button
            type="button"
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="py-xl-5 py-4 px-3 bg-light mt-5">
            <div class="text-center  h-100">
                ...
                <a class="fs-14 text-info" href="{{ route("user.support.ticket.create") }}"><i class="ri-information-2-line fs-18"></i>{{ translate("Need help to get started?") }}</a>
